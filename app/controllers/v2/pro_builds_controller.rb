...
module V2
  class ProBuildsController < V1::ProBuildsController
    def index
      ...
      return render(json: proBuilds, meta: pagination_dict(proBuilds), include: '**', fields: { proBuilds: [:id, :gameCreation, :gameDuration, :spell1Id, :spell2Id, :stats, :championId, :champion, :pro_summoner] })
    end
  end
end
